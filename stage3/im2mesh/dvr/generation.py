...
class Generator3D(object):
    ...
    def generate_mesh(self, data, return_stats=True):
        ...
        #c=torch.from_numpy(np.load('/mnt/sdc/lzz/bigmapper_test_2stage2_disc/cases/sofa/a sofa with black backrest/c.npy')).cuda()
        c=torch.from_numpy(np.load('/mnt/sdc/lzz/bigmapper_test_2stage2_disc/a blue car/c.npy')).cuda()
