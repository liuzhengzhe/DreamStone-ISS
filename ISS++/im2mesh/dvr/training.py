...
class Trainer(BaseTrainer):
    ...
    def train_step(self, data,c, condition1, text,root, it=None):
        ...
        loss,clip_loss1, clip_loss2,dis = self.compute_loss(data,c, condition1, text, root, it=it)
    ...
    def compute_loss(self, data, c_clip, condition1, text, root,  eval_mode=False, it=None):
        ''' Compute the loss.
        ...
        for rrr in range(int(10/N)):
          ...
          if rrr==0:
            ...
            cv2.imwrite(root+text+'/rgbclip'+str(len(glob.glob(root+text+'/rgbclip*.png'))+1)+'.png',rgb_pred_np_reshape[0,:,:,::-1]*255)
          ...
          clip_loss1=torch.sum((1-torch.sum(image_features*condition1.detach())))*4 #torch.sum((1-self.clip_criterion(image_features, condition1.detach())))*4
