...
class Trainer(object):
    ...
    def train_step(self, data):
        ...
        #print ('rays_d',rays_d.shape, torch.unique(rays_d), rays_d.norm(dim=-1))
        ...
        #except:
        #  outputs = self.model.render(rays_o, rays_d, staged=False, perturb=True, bg_color=bg_color, ambient_ratio=1.0, shading='albedo', force_all_rays=True, **vars(self.opt))
        ...
        #print (self.model.model.decoder.fc_p.weight.grad, 'grad 0')
        ...
        #print ('1',loss)
        #print (self.model.model.decoder.fc_p.weight.grad, 'grad 1')
        ...
        if self.opt.lambda_opacity > 0:
            ...
            #print ('2', self.opt.lambda_opacity , loss_opacity)
        if self.opt.lambda_entropy > 0:
            ...
            #print ('3', self.opt.lambda_entropy , loss_entropy)

        if self.opt.lambda_orient > 0 and 'loss_orient' in outputs:
            loss_orient = outputs['loss_orient']
            loss = loss + self.opt.lambda_orient * loss_orient
            #print ('4', self.opt.lambda_orient , loss_orient)
        ...
        if self.opt.lambda_smooth > 0 and 'loss_smooth' in outputs:
            ...
            #print ('5', self.opt.lambda_smooth , loss_smooth)
    ...
    def train_one_epoch(self, loader):
        ...
        for data in loader:
            ...
            try:
              ...
              #print (self.model.model.decoder.fc_p.weight.grad, 'grad')
