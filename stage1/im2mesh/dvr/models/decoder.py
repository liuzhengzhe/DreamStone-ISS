...
'''class generator(nn.Module):
	def __init__(self,  gf_dim):
		...
		self.linear_2x = nn.Linear(self.gf_dim*8, self.gf_dim*4, bias=True)
		self.linear_3x = nn.Linear(self.gf_dim*4, self.gf_dim*4, bias=True)
		#self.linear_4 = nn.Linear(self.gf_dim*8, self.gf_dim*4, bias=True)

		nn.init.normal_(self.linear_1.weight, mean=0.0, std=0.02)
		nn.init.constant_(self.linear_1.bias,0)
		nn.init.normal_(self.linear_2x.weight, mean=0.0, std=0.02)
		nn.init.constant_(self.linear_2x.bias,0)
		nn.init.normal_(self.linear_3x.weight, mean=0.0, std=0.02)
		nn.init.constant_(self.linear_3x.bias,0)
	...
	def forward(self, clip_feature, is_training=False):
		...
		l2 = self.linear_2x(l1)
		l2 = F.leaky_relu(l2, negative_slope=0.02, inplace=True)

		l3 = self.linear_3x(l2)
