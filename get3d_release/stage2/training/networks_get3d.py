...
class DMTETSynthesisNetwork(torch.nn.Module):
    ...
    def extract_3d_shape(
        ...
        :return:
        '''
        print (ws.shape, ws_geo.shape, 'ws ws geo')
    ...
    def generate(
        ...
        if self.render_type == 'neural_render':
            ...
            raise NotImplementedError
        #print ('antilias_mask',torch.unique(antilias_mask), antilias_mask.shape,torch.unique(hard_mask), hard_mask.shape, )

        img = torch.cat([img, hard_mask.permute(0, 3, 1, 2)], dim=1)
...
class GeneratorDMTETMesh(torch.nn.Module):
    ...
    def generate_3d_mesh(
            ...
            with_texture=True, use_style_mixing=False, use_mapping=False, **synthesis_kwargs):
        '''
        ...
        if use_style_mixing:
            ...
            ws[:, cutoff:] = self.mapping(
                ...
                truncation_cutoff=truncation_cutoff
                             ...
                             cutoff:]
        #print ('extact', ws.shape, ws_geo.shape)
