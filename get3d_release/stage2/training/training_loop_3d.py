...
def training_loop(
    ...
    optimizer = optim.Adam([{"params": mapper.parameters(), "lr": 2e-6}])  #std: 1e-6 #, {"params": c_clip, "lr": lr*1}]) #model.decoder_color.parameters(), lr=lr*1) #([{"params": model.encoder.parameters(), "lr": lr*1}, {"params": model.decoder.parameters(), "lr": lr*01}], lr=lr)
