...
@click.command()
@click.option('--text',  help='Input texxt', required=True)
@click.option('--stage1_model',  help='Path to stage1 model for training, and path to the mapper for inference', required=True)
...
def main(**kwargs):
    ...
    c.text = opts.text
    c.stage1_model=opts.stage1_model
