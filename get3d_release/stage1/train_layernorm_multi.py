...
class generator(nn.Module):
	def __init__(self,  gf_dim):
		...
		self.linear_4 = nn.Linear(self.gf_dim*128, self.gf_dim*8, bias=True)
		self.linear_5 = nn.Linear(self.gf_dim*128, self.gf_dim*8, bias=True)
		self.linear_6 = nn.Linear(self.gf_dim*128, self.gf_dim*8,  bias=True)
		self.linear_7 = nn.Linear(self.gf_dim*128, self.gf_dim*8, bias=True)
		self.linear_8 = nn.Linear(self.gf_dim*128, self.gf_dim*8, bias=True)
		self.linear_9 = nn.Linear(self.gf_dim*128, self.gf_dim*8, bias=True)
		self.linear_10 = nn.Linear(self.gf_dim*128, self.gf_dim*8, bias=True)
		self.linear_11 = nn.Linear(self.gf_dim*128, self.gf_dim*8, bias=True)
		self.linear_12 = nn.Linear(self.gf_dim*128, self.gf_dim*8,  bias=True) 
		self.linear_13 = nn.Linear(self.gf_dim*128, self.gf_dim*8,  bias=True) 
		self.linear_14 = nn.Linear(self.gf_dim*128, self.gf_dim*8,  bias=True) 
		self.linear_15 = nn.Linear(self.gf_dim*128, self.gf_dim*8,  bias=True) 
		self.linear_16 = nn.Linear(self.gf_dim*128, self.gf_dim*8,  bias=True) 
		self.linear_17 = nn.Linear(self.gf_dim*128, self.gf_dim*8,  bias=True) 
		self.linear_18 = nn.Linear(self.gf_dim*128, self.gf_dim*8,  bias=True) 
		self.linear_19 = nn.Linear(self.gf_dim*128, self.gf_dim*8,  bias=True) 
		self.linear_20 = nn.Linear(self.gf_dim*128, self.gf_dim*8,  bias=True) 
		self.linear_21 = nn.Linear(self.gf_dim*128, self.gf_dim*8,  bias=True) 
		self.linear_22 = nn.Linear(self.gf_dim*128, self.gf_dim*8,  bias=True) 
		self.linear_23 = nn.Linear(self.gf_dim*128, self.gf_dim*8,  bias=True) 
		self.linear_24 = nn.Linear(self.gf_dim*128, self.gf_dim*8,  bias=True) 
		self.linear_25 = nn.Linear(self.gf_dim*128, self.gf_dim*8,  bias=True) 
		#self.linear_26 = nn.Linear(self.gf_dim*128, self.gf_dim*128,  bias=True) 


		self.linear_4x = nn.Linear(self.gf_dim*128, self.gf_dim*8, bias=True)
		self.linear_5x = nn.Linear(self.gf_dim*128, self.gf_dim*8, bias=True)
		self.linear_6x = nn.Linear(self.gf_dim*128, self.gf_dim*8,  bias=True)
		self.linear_7x = nn.Linear(self.gf_dim*128, self.gf_dim*8, bias=True)
		self.linear_8x = nn.Linear(self.gf_dim*128, self.gf_dim*8, bias=True)
		self.linear_9x = nn.Linear(self.gf_dim*128, self.gf_dim*8, bias=True)
		self.linear_10x = nn.Linear(self.gf_dim*128, self.gf_dim*8, bias=True)
		self.linear_11x = nn.Linear(self.gf_dim*128, self.gf_dim*8, bias=True)
		self.linear_12x = nn.Linear(self.gf_dim*128, self.gf_dim*8,  bias=True) 
...
for epoch in range(3,epochs):
	for clip_image, g_gt,c_gt in dataloders:
		...
		if epoch % 2 == 0: 
			torch.save(model.state_dict(), 'model_32'+str(epoch)+'.pt')
			try:
				os.remove('modelsmall_32'+str(epoch-4)+'.pt')
			except:
				pass