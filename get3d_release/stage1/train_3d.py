...
@click.option('--inference_save_interpolation', help='inference to generate interpolation results', metavar='BOOL', type=bool, default=True, show_default=False)
...
def main(**kwargs):
    ...
    if opts.desc is not None:
        desc += f'-{opts.desc}'
    # Launch.
    print('==> launch training',flush=True)
