...
# Decoder dictionary
decoder_dict = {
    'decoder_shape': decoder.Decoder_shape,
    'decoder_color': decoder.Decoder_color,
...
class DVR(nn.Module):
    ...
    def __init__(self, decoder_shape, decoder_color, generator, encoder=None,
                 device=None, depth_function_kwargs={}):
        super().__init__()
        self.decoder_shape = decoder_shape.to(device)
        self.decoder_color = decoder_color.to(device)
    ...
    def get_central_difference(self, points, c=None, h=1e-3):
        ...
        f = self.decoder_shape(points_eval, c=c, only_occupancy=True,
    ...
    def decode(self, p, c=None, **kwargs):
        ...
        logits = self.decoder_shape(p, c, only_occupancy=True, **kwargs)
    ...
    def march_along_ray(self, ray0, ray_direction, c=None, it=None,
        ...
        d_i = self.call_depth_function(ray0, ray_direction, self.decoder_shape,
    ...
    def decode_color(self, p_world, c=None, **kwargs):
        ...
        Args:
            ...
            c (tensor): latent conditioned code c
        '''
        rgb_hat = self.decoder_color(p_world, c=c, only_texture=True)
